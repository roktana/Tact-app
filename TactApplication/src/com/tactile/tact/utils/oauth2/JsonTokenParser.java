...
import com.tactile.tact.utils.oauth2.crypto.AsciiStringVerifier;
import com.tactile.tact.utils.oauth2.crypto.SignatureAlgorithm;
import com.tactile.tact.utils.oauth2.crypto.Verifier;
import com.tactile.tact.utils.oauth2.discovery.VerifierProviders;
...
public class JsonTokenParser {
  ...
  private List<Verifier> provideVerifiers(JsonToken jsonToken) throws SignatureException {
    ...
    List<Verifier> verifiers = verifierProviders.getVerifierProvider(sigAlg).findVerifier(jsonToken.getIssuer(), keyId);
    if (verifiers == null) {
