...
import com.tactile.tact.utils.oauth2.crypto.MagicRsaPublicKey;
...
public class JsonServerInfo implements ServerInfo {
  ...
  /*
   * (non-Javadoc)
   * @see com.tactile.tact.util.oauth2.discovery.ServerInfo#getVerificationKey(java.lang.String)
   */
  @Override
