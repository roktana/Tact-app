 ...
 *
 */
package com.tactile.tact.utils.oauth2.crypto;
...
public class RsaSHA256Signer extends AbstractSigner {
  ...
  /*
   * (non-Javadoc)
   * @see com.tactile.tact.util.oauth2.crypto.Signer#getSignatureAlgorithm()
   */
  @Override
  ...
  /*
   * (non-Javadoc)
   * @see com.tactile.tact.util.oauth2.crypto.Signer#sign(byte[])
   */
  @Override
