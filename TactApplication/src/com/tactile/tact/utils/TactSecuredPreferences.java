...
public class TactSecuredPreferences {
	 ...
	 * @throws com.tactile.tact.utils.TactSecuredPreferences.SecurePreferencesException
	 */
	public TactSecuredPreferences(Context context, String preferenceName, String secureKey, boolean encryptKeys) throws SecurePreferencesException {
		try {
	...
	public TactSecuredPreferences(Context context, String secureKey, boolean encryptKeys) throws SecurePreferencesException {
		try {
			this.writer = Cipher.getInstance(TRANSFORMATION);
			this.reader = Cipher.getInstance(TRANSFORMATION);
			this.keyWriter = Cipher.getInstance(KEY_TRANSFORMATION);
