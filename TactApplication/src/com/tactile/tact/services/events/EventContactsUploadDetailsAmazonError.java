 ...
 */
public class EventContactsUploadDetailsAmazonError extends EventTactBase {

    public EventContactsUploadDetailsAmazonError(boolean isCritical, int code, String message) {
